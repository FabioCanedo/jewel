...
#export FileDir="/sampa/fcanedo/IC/vusphydro/PbPb_2760_GeV"
...
export YODA_SHAPE_FILE="/sampa/fcanedo/results/histograms/pp_2760_GeV/shape_pp/shape.pp."$NJOB".yoda"
export YODA_VN_FILE="/sampa/fcanedo/results/histograms/pp_2760_GeV/vn_pp/vn.pp."$NJOB".yoda"
export YODA_ZHADRON_FILE="/sampa/fcanedo/results/histograms/pp_2760_GeV/z_hadron/pp."$NJOB".yoda"

chmod 777 $MacroDir/jewel-2.2.0-vac
...
cd $MacroDir/params/pp_2760_GeV/
...
cd $MacroDir/medparams/pp_2760_GeV/
cp pp.dat pp."$NJOB".dat
