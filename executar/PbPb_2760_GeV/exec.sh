...
export HEPMC_FILE=$HEPMC_FOLDER"exec_"$tc"_$2_."$NJOB".hepmc"
export YODA_FOLDER="/sampa/fcanedo/results/histograms/PbPb_"$energy"_GeV/cent"$mincent"_"$maxcent"/"
export YODA_GENERIC_FILE=$YODA_FOLDER"exec_"$tc"_"$energy"_."$NJOB".yoda"
export YODA_RAA_FILE=$YODA_FOLDER"raa.exec_"$tc"_"$energy"_."$NJOB".yoda"
export YODA_SHAPE_FILE=$YODA_FOLDER"shape.exec_"$tc"_"$energy"_."$NJOB".yoda"
export YODA_VN_FILE=$YODA_FOLDER"vn.exec_"$tc"_"$energy"_."$NJOB".yoda"
export YODA_ZHADRON_FILE=$YODA_FOLDER"zhadron.exec_"$tc"_"$energy"_."$NJOB".yoda"
...
if true ; then
      ...
      sed -i "s/\(MDSCALEFAC\s\).*/\1$mdsfactord0/g" exec."$NJOB".dat
