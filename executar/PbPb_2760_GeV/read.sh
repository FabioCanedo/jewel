...
export FileDir="/sampa/fcanedo/IC/mymedf/PbPb_2760_GeV/0_10"
...
export YODA_GENERIC_FILE="/sampa/fcanedo/results/histograms/PbPb_2760_GeV/cent0_10/read/read."$NJOB".yoda"
export YODA_SHAPE_FILE="/sampa/fcanedo/results/histograms/PbPb_2760_GeV/cent0_10/read/shape.read."$NJOB".yoda"
export YODA_VN_FILE="/sampa/fcanedo/results/histograms/PbPb_2760_GeV/cent0_10/read/vn.read."$NJOB".yoda"
export YODA_ZHADRON_FILE="/sampa/fcanedo/results/histograms/PbPb_2760_GeV/cent0_10/read."$NJOB".yoda"
