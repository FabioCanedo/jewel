...
export FileDir="/sampa/fcanedo/IC/mymedf/PbPb_5020_GeV/0_10"
...
export HEPMC_FILE="/sampa/fcanedo/jewel-2.2.0/hepmc/PbPb_5020_GeV/cent0_10/read."$NJOB".hepmc"
export YODA_GENERIC_FILE="/sampa/fcanedo/results/histograms/PbPb_5020_GeV/cent0_10/read/read."$NJOB".yoda"
export YODA_SHAPE_FILE="/sampa/fcanedo/results/histograms/PbPb_5020_GeV/cent0_10/read/shape.read."$NJOB".yoda"
export YODA_VN_FILE="/sampa/fcanedo/results/histograms/PbPb_5020_GeV/cent0_10/read/vn.read."$NJOB".yoda"
export YODA_ZHADRON_FILE="/sampa/fcanedo/results/histograms/PbPb_5020_GeV/cent0_10/read."$NJOB".yoda"
...
sed -i "s/\(NJOB\s\).*/\1"$NJOB"/g" read0_10."$NJOB".dat
sed -i "s/\(LOGFILE\s.*read\.\).*/\1"$NJOB".log/g" read0_10."$NJOB".dat
sed -i "s/\(HEPMCFILE\s.*read\.\).*/\1"$NJOB".hepmc/g" read0_10."$NJOB".dat
sed -i "s/\(MEDIUMPARAMS\s.*read0_10\.\).*/\1"$NJOB".dat/g" read0_10."$NJOB".dat
sed -i "s/\(XSECFILE\s.*read_\).*/\1"$NJOB".dat/g" read0_10."$NJOB".dat
sed -i "s/\(SPLITINTFILE\s.*read_\).*/\1"$NJOB".dat/g" read0_10."$NJOB".dat
sed -i "s/\(PDFFILE\s.*read_\).*/\1"$NJOB".dat/g" read0_10."$NJOB".dat
...
cd $MacroDir/integrals
rm xsecs_read0_10_$NJOB".dat"
rm splitint_read0_10_$NJOB".dat"
rm pdfs_read0_10_$NJOB".dat"

cd $MacroDir/params/PbPb_5020_GeV/
rm read0_10."$NJOB".dat
