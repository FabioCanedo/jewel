...
export FileDir="/sampa/fcanedo/IC/exechydro/PbPb_5020_GeV"
...
export HEPMC_FILE="/sampa/fcanedo/jewel-2.2.0/hepmc/PbPb_5020_GeV/cent0_10/exec."$NJOB".hepmc"
export YODA_GENERIC_FILE="/sampa/fcanedo/results/histograms/PbPb_5020_GeV/cent0_10/exec/exec."$NJOB".yoda"
export YODA_SHAPE_FILE="/sampa/fcanedo/results/histograms/PbPb_5020_GeV/cent0_10/exec/shape.exec."$NJOB".yoda"
export YODA_VN_FILE="/sampa/fcanedo/results/histograms/PbPb_5020_GeV/cent0_10/exec/vn.exec."$NJOB".yoda"
export YODA_ZHADRON_FILE="/sampa/fcanedo/results/histograms/PbPb_5020_GeV/cent0_10/exec."$NJOB".yoda"
...
cd $MacroDir
$MacroDir/jewel-2.2.0-simple $MacroDir/params/PbPb_5020_GeV/exec."$NJOB".dat
